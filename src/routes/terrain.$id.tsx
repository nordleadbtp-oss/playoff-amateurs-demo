...
const SLOTS_BY_DOW: Record<number, Omit<Slot, "price">[]> = {
  ...
  1: [{ id: "s7", time: "10:00", status: "available" }, { id: "s8", time: "12:00", status: "available" }, { id: "s9", time: "15:00", status: "full" }, { id: "s10", time: "17:00", status: "available" }, { id: "s11", time: "19:00", status: "available" }],
  2: [{ id: "s12", time: "08:00", status: "available" }, { id: "s13", time: "10:00", status: "available" }, { id: "s14", time: "14:00", status: "available" }, { id: "s15", time: "16:00", status: "full" }, { id: "s16", time: "20:00", status: "available" }],
  3: [{ id: "s17", time: "09:00", status: "full" }, { id: "s18", time: "11:00", status: "available" }, { id: "s19", time: "18:00", status: "available" }, { id: "s20", time: "20:00", status: "available" }],
  4: [{ id: "s21", time: "12:00", status: "available" }, { id: "s22", time: "14:00", status: "available" }, { id: "s23", time: "17:00", status: "full" }, { id: "s24", time: "19:00", status: "available" }, { id: "s25", time: "21:00", status: "available" }],
